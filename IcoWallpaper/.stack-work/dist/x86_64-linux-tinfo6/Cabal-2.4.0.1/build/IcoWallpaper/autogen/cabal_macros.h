...
/* package IcoWallpaper-0.1.0.0 */
#ifndef VERSION_IcoWallpaper
#define VERSION_IcoWallpaper "0.1.0.0"
#endif /* VERSION_IcoWallpaper */
#ifndef MIN_VERSION_IcoWallpaper
#define MIN_VERSION_IcoWallpaper(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_IcoWallpaper */

/* package GLFW-b-3.2.1.1 */
#ifndef VERSION_GLFW_b
#define VERSION_GLFW_b "3.2.1.1"
...
#define CURRENT_COMPONENT_ID "IcoWallpaper-0.1.0.0-Ls2F8VBhJ8k5QaDujkdRWQ-IcoWallpaper"
