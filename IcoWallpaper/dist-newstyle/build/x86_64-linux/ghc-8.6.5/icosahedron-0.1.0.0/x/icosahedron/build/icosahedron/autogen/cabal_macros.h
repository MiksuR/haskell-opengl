...
/* package icosahedron-0.1.0.0 */
#ifndef VERSION_icosahedron
#define VERSION_icosahedron "0.1.0.0"
#endif /* VERSION_icosahedron */
#ifndef MIN_VERSION_icosahedron
#define MIN_VERSION_icosahedron(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_icosahedron */
...
#define CURRENT_COMPONENT_ID "icosahedron-0.1.0.0-inplace-icosahedron"
